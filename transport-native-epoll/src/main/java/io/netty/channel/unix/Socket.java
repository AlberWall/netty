...
public final class Socket extends FileDescriptor {
    private static final ClosedChannelException SHUTDOWN_CLOSED_CHANNEL_EXCEPTION = new ClosedChannelException();
    private static final ClosedChannelException SEND_TO_CLOSED_CHANNEL_EXCEPTION = new ClosedChannelException();
    private static final ClosedChannelException SEND_TO_ADDRESS_CLOSED_CHANNEL_EXCEPTION = new ClosedChannelException();
    ...
    static {
        ThrowableUtil.setUnknownStackTrace(SHUTDOWN_CLOSED_CHANNEL_EXCEPTION, Socket.class, "shutdown(...)");
        ThrowableUtil.setUnknownStackTrace(SEND_TO_CLOSED_CHANNEL_EXCEPTION, Socket.class, "sendTo(...)");
        ThrowableUtil.setUnknownStackTrace(SEND_TO_ADDRESS_CLOSED_CHANNEL_EXCEPTION,
                Socket.class, "sendToAddress(...)");
        ThrowableUtil.setUnknownStackTrace(SEND_TO_ADDRESSES_CLOSED_CHANNEL_EXCEPTION,
                Socket.class, "sendToAddresses(...)");

        SEND_TO_CONNECTION_RESET_EXCEPTION = Errors.newConnectionResetException("syscall:sendto(...)",
                Errors.ERRNO_EPIPE_NEGATIVE);
        ThrowableUtil.setUnknownStackTrace(SEND_TO_CONNECTION_RESET_EXCEPTION,
                Socket.class, "sendTo(...)");
        SEND_TO_ADDRESS_CONNECTION_RESET_EXCEPTION = Errors.newConnectionResetException("syscall:sendto(...)",
                Errors.ERRNO_EPIPE_NEGATIVE);
        ThrowableUtil.setUnknownStackTrace(SEND_TO_ADDRESS_CONNECTION_RESET_EXCEPTION,
                Socket.class, "sendToAddress(...)");
        CONNECTION_RESET_EXCEPTION_SENDMSG = Errors.newConnectionResetException("syscall:sendmsg(...)",
                Errors.ERRNO_EPIPE_NEGATIVE);
        CONNECTION_NOT_CONNECTED_SHUTDOWN_EXCEPTION = Errors.newConnectionResetException("syscall:shutdown(...)",
                Errors.ERRNO_ENOTCONN_NEGATIVE);
        ThrowableUtil.setUnknownStackTrace(CONNECTION_NOT_CONNECTED_SHUTDOWN_EXCEPTION,
                Socket.class, "shutdown(...)");
    }
