...
public final class Native {
    ...
    private static final ClosedChannelException SENDFILE_CLOSED_CHANNEL_EXCEPTION = new ClosedChannelException();
    private static final ClosedChannelException SENDMMSG_CLOSED_CHANNEL_EXCEPTION = new ClosedChannelException();
    private static final ClosedChannelException SPLICE_CLOSED_CHANNEL_EXCEPTION = new ClosedChannelException();
    ...
    static {
        ...
        ThrowableUtil.setUnknownStackTrace(SENDFILE_CLOSED_CHANNEL_EXCEPTION, Native.class, "sendfile(...)");
        ThrowableUtil.setUnknownStackTrace(SENDMMSG_CLOSED_CHANNEL_EXCEPTION, Native.class, "sendmmsg(...)");
        ThrowableUtil.setUnknownStackTrace(SPLICE_CLOSED_CHANNEL_EXCEPTION, Native.class, "splice(...)");
    }
