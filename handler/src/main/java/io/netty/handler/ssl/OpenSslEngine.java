...
public final class OpenSslEngine extends SSLEngine {
    ...
    private static final SSLException BEGIN_HANDSHAKE_ENGINE_CLOSED = new SSLException("engine closed");
    private static final SSLException HANDSHAKE_ENGINE_CLOSED = new SSLException("engine closed");
    ...
    static {
        ThrowableUtil.setUnknownStackTrace(BEGIN_HANDSHAKE_ENGINE_CLOSED, OpenSslEngine.class, "beginHandshake()");
        ThrowableUtil.setUnknownStackTrace(HANDSHAKE_ENGINE_CLOSED, OpenSslEngine.class, "handshake()");
        ThrowableUtil.setUnknownStackTrace(RENEGOTIATION_UNSUPPORTED, OpenSslEngine.class, "beginHandshake()");
        ThrowableUtil.setUnknownStackTrace(ENCRYPTED_PACKET_OVERSIZED, OpenSslEngine.class, "unwrap(...)");
