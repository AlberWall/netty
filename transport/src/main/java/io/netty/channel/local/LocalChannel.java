...
public class LocalChannel extends AbstractChannel {
    ...
    private static final ClosedChannelException DO_WRITE_CLOSED_CHANNEL_EXCEPTION = new ClosedChannelException();
    ...
    static {
        ...
        ThrowableUtil.setUnknownStackTrace(DO_WRITE_CLOSED_CHANNEL_EXCEPTION, LocalChannel.class, "doWrite(...)");
        ThrowableUtil.setUnknownStackTrace(DO_CLOSE_CLOSED_CHANNEL_EXCEPTION, LocalChannel.class, "doClose()");
    }
